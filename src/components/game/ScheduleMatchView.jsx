        ...
        <div key={`${viewingRoundIdx}_${i}`} style={{ marginBottom: 18 }}>
          ...
          <CourtRecorder
            ...
            absentees={isConfirmed
              ...
              : absentees}
            onToggleAbsent={isConfirmed
              ? (onEditPastAbsent ? (({ matchId, teamIdx, player }) => onEditPastAbsent({ matchId, teamIdx, player })) : undefined)
              : onToggleAbsent}
          />
        </div>
        );
